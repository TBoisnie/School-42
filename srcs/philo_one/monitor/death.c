...
/*   Updated: 2020/12/04 23:25:56 by tboisnie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	*s_death(void *args_v)
{
	...
	{
		if (pthread_mutex_lock(&args->c->write_locker))
		{
			ret_error(0, "Error: s_death - Mutex lock failed.\n");
		}
		...
		if (pthread_mutex_unlock(&args->c->write_locker))
		{
			ret_error(0, "Error: s_death - Mutex unlock failed.\n");
		}
		sleep_ms(1);
	}
	return (0);
