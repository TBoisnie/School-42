...
#define FT_INT_64_MIN  (-9223372036854775807 - 1)

#define FT_INT_8_MAX   (127)
#define FT_INT_16_MAX  (32767)
#define FT_INT_32_MAX  (2147483647)
#define FT_INT_64_MAX  (9223372036854775807)

#define FT_UINT_8_MIN  (0)
#define FT_UINT_16_MIN (0)
#define FT_UINT_32_MIN (0)
#define FT_UINT_64_MIN (0)

#define FT_UINT_8_MAX  (256)
#define FT_UINT_16_MAX (65535)
#define FT_UINT_32_MAX (4294967295)
#define FT_UINT_64_MAX (18446744073709551615)
