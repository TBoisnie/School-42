...
#define FT_MEM_BIT_ROTATE_LEFT(m, n, s)   (((m) << (n)) | ((m) >> ((s) - (n))))
#define FT_MEM_BIT_ROTATE_RIGHT(m, n, s)  (((m) >> (n)) | ((m) << ((s) - (n))))

#define FT_MEM_BYTE_ENDIAN_SWAP_16(m) \
	( \
		  (m >> 8 & 0x00ff) \
		| (m << 8 & 0xff00) \
	)
#define FT_MEM_BYTE_ENDIAN_SWAP_32(m) \
	( \
		  (m >> 24 & 0x000000ff) \
		| (m >>  8 & 0x0000ff00) \
		| (m <<  8 & 0x00ff0000) \
...
#define FT_MEM_BYTE_ENDIAN_SWAP_64(m) \
	( \
		  (m >> 56 & 0x00000000000000ff) \
		| (m >> 40 & 0x000000000000ff00) \
		| (m >> 24 & 0x0000000000ff0000) \
		| (m >>  8 & 0x00000000ff000000) \
		| (m <<  8 & 0x000000ff00000000) \
		| (m << 24 & 0x0000ff0000000000) \
		| (m << 40 & 0x00ff000000000000) \
		| (m << 56 & 0xff00000000000000) \
	)

// Alias -----------------------------------------------------------------------
#define FT_MEM_BIT_ROTATE_LEFT_8(m, n)   FT_MEM_BIT_ROTATE_LEFT(m, n, 8)
#define FT_MEM_BIT_ROTATE_LEFT_16(m, n)  FT_MEM_BIT_ROTATE_LEFT(m, n, 16)
#define FT_MEM_BIT_ROTATE_LEFT_32(m, n)  FT_MEM_BIT_ROTATE_LEFT(m, n, 32)
#define FT_MEM_BIT_ROTATE_LEFT_64(m, n)  FT_MEM_BIT_ROTATE_LEFT(m, n, 64)

#define FT_MEM_BIT_ROTATE_RIGHT_8(m, n)   FT_MEM_BIT_ROTATE_RIGHT(m, n, 8)
#define FT_MEM_BIT_ROTATE_RIGHT_16(m, n)  FT_MEM_BIT_ROTATE_RIGHT(m, n, 16)
#define FT_MEM_BIT_ROTATE_RIGHT_32(m, n)  FT_MEM_BIT_ROTATE_RIGHT(m, n, 32)
#define FT_MEM_BIT_ROTATE_RIGHT_64(m, n)  FT_MEM_BIT_ROTATE_RIGHT(m, n, 64)
